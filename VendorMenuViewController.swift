    ...
    override func viewDidLoad() {
       ...
       menuListTableView.dataSource = self
        ...
        if customerType == 2 {
            ...
            listImageArray = ["v_ic_order" , "v_ic_customer" , "v_ic_products" , "v_ic_global_products" , "v_ic_new_product" , "v_ic_store_profile" , "v_ic_promotion" , "v_ic_category" , "v_ic_subscription" , "v_ic_history", "v_ic_history", "ic_personalvendoredit" , "v_ic_update" , "v_ic_store_profile", "v_ic_logout"]
        }else{
            
            listArray = ["Orders" , "Customers" , "My Products" , "Product Global List" , "New Product" , "Store Profile" ,"Promotions", "Categories" , "Subscription Details" , "Payment details" , "Services" , "Switch profile" , "Update Vendor Profile" , "Update profile Account" , "About us" , "Logout"]
