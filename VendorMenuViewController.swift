...
class VendorMenuViewController: UIViewController , UITableViewDelegate , UITableViewDataSource {
    ...
    override func viewDidLoad() {
       ...
       listImageArray = ["v_ic_order" , "v_ic_customer" , "v_ic_products" , "v_ic_global_products" , "v_ic_order" , "v_ic_new_product" , "v_ic_store_profile" , "v_ic_promotion" , "v_ic_category" , "v_ic_subscription" , "v_ic_subscription" , "ch_ic_switch_profile" , "v_ic_update" , "v_ic_store_profile", "v_ic_logout"]
