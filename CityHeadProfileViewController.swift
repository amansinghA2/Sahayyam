...
class CityHeadProfileViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate , TTTAttributedLabelDelegate{
    ...
    override func viewDidLoad() {
        ...
        phoneNumber.setTextFieldStyle(TextFieldStyle.MobileNumber)
        // dataInTextField()
    ...
    func formValidation() -> Bool{
        if (firstNameLabel.text?.isBlank == true  || lastNameLabel.text?.isBlank == true || phoneNumber.text?.isBlank == true || dateOfBirthTextField.text?.isBlank == true || passwordTextField.text?.isBlank == true || confirmPassword.text?.isBlank == true){
            self.hideHud()
    ...
    func dataInTextField(){
        ...
        phoneNumber.text = populateDataList.mobileNumber
        ...
        if populateDataList.image1 != "" {
            let image = populateDataList.image1.stringByReplacingOccurrencesOfString(" ", withString:"%20")
